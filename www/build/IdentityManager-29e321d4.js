import { y, j as j$1, z, U, p as v$2, Z, m as I, F, J, Q, B as Bt, a as n$4, q as o } from './request-ac4d8bfb.js';
import { e as e$1, d as d$1, n as n$1, v as n$2, am as y$1, aQ as D$1, A as v$1, a as s$4, w as p$3, u as r$1, f as r$2, k as t$1 } from './cast-3d5be210.js';
...
import { O, n, v, e as e$2 } from './jsxFactory-4cd653a4.js';
import { e as e$3 } from './widget-a58988b6.js';
...
*/
const a={base:"esri-identity-form",group:"esri-identity-form__group",label:"esri-identity-form__label",footer:"esri-identity-form__footer",esriInput:"esri-input",esriButton:"esri-button",esriButtonSecondary:"esri-button--secondary"},l$1="ArcGIS Online";let p$2=class extends O{constructor(s,e){super(s,e),this._usernameInputNode=null,this._passwordInputNode=null,this.messages=null,this.signingIn=!1,this.server=null,this.resource=null,this.error=null,this.oAuthPrompt=!1;}render(){const{error:s,server:e,resource:t,signingIn:o,oAuthPrompt:n$1,messages:p}=this,d=n("div",{class:a.group},s$3(n$1?p.oAuthInfo:p.info,{server:/\.arcgis\.com/i.test(e)?l$1:e,resource:`(${t||p.lblItem})`})),c=n$1?null:n("div",{class:a.group,key:"username"},n("label",{class:a.label},p.lblUser,n("input",{value:"",required:!0,autocomplete:"off",spellcheck:!1,type:"text",bind:this,afterCreate:v,"data-node-ref":"_usernameInputNode",class:a.esriInput}))),m=n$1?null:n("div",{class:a.group,key:"password"},n("label",{class:a.label},p.lblPwd,n("input",{value:"",required:!0,type:"password",bind:this,afterCreate:v,"data-node-ref":"_passwordInputNode",class:a.esriInput}))),h=n("div",{class:this.classes(a.group,a.footer)},n("input",{type:"submit",disabled:!!o,value:o?p.lblSigning:p.lblOk,class:a.esriButton}),n("input",{type:"button",value:p.lblCancel,bind:this,onclick:this._cancel,class:this.classes(a.esriButton,a.esriButtonSecondary)})),b=s?n("div",null,s.details&&s.details.httpStatus?p.invalidUser:p.noAuthService):null;return n("form",{class:a.base,bind:this,onsubmit:this._submit},d,b,c,m,h)}_cancel(){this._set("signingIn",!1),this._usernameInputNode&&(this._usernameInputNode.value=""),this._passwordInputNode&&(this._passwordInputNode.value=""),this.emit("cancel");}_submit(s){s.preventDefault(),this._set("signingIn",!0);const e=this.oAuthPrompt?{}:{username:this._usernameInputNode&&this._usernameInputNode.value,password:this._passwordInputNode&&this._passwordInputNode.value};this.emit("submit",e);}};e$1([d$1(),e$2("esri/identity/t9n/identity")],p$2.prototype,"messages",void 0),e$1([d$1()],p$2.prototype,"signingIn",void 0),e$1([d$1()],p$2.prototype,"server",void 0),e$1([d$1()],p$2.prototype,"resource",void 0),e$1([d$1()],p$2.prototype,"error",void 0),e$1([d$1()],p$2.prototype,"oAuthPrompt",void 0),p$2=e$1([n$1("esri.identity.IdentityForm")],p$2);const d=p$2;
...
See https://js.arcgis.com/4.24/esri/copyright.txt for details.
*/
const l={base:"esri-identity-modal",open:"esri-identity-modal--open",closed:"esri-identity-modal--closed",title:"esri-identity-modal__title",dialog:"esri-identity-modal__dialog",content:"esri-identity-modal__content",closeButton:"esri-identity-modal__close-button",iconClose:"esri-icon-close"};let p$1=class extends O{constructor(t,e){super(t,e),this.container=document.createElement("div"),this.content=null,this.open=!1,this._close=()=>{this.open=!1;},document.body.appendChild(this.container),this.own(l$2((()=>this.open),(()=>this._toggleFocusTrap())));}destroy(){this._destroyFocusTrap();}render(){const t=this.id,{open:e,content:o,title:s,messages:i}=this,r=e&&!!o,n$1={[l.open]:r,[l.closed]:!r},a=n("button",{class:l.closeButton,"aria-label":i.close,title:i.close,bind:this,onclick:this._close,type:"button"},n("span",{"aria-hidden":"true",class:l.iconClose})),c=`${t}_title`,p=`${t}_content`,u=s?n("h1",{id:c,class:l.title},s):null,m=r?n("div",{bind:this,class:l.dialog,role:"dialog","aria-labelledby":c,"aria-describedby":p,afterCreate:this._createFocusTrap},a,u,this._renderContent(p)):null;return n("div",{tabIndex:-1,class:this.classes(l.base,n$1)},m)}_destroyFocusTrap(){this._focusTrap?.deactivate({onDeactivate:null}),this._focusTrap=null;}_toggleFocusTrap(){const{_focusTrap:t,open:e}=this;t&&(e?t.activate():t.deactivate());}_createFocusTrap(t){this._destroyFocusTrap();const o=requestAnimationFrame((()=>{this._focusTrap=createFocusTrap(t,{initialFocus:"input",onDeactivate:this._close}),this._toggleFocusTrap();}));this.own(n$2((()=>cancelAnimationFrame(o))));}_renderContent(t){const e=this.content;return "string"==typeof e?n("div",{class:l.content,id:t,innerHTML:e}):e$3(e)?n("div",{class:l.content,id:t},e.render()):e instanceof HTMLElement?n("div",{class:l.content,id:t,bind:e,afterCreate:this._attachToNode}):null}_attachToNode(t){const e=this;t.appendChild(e);}};e$1([d$1({readOnly:!0})],p$1.prototype,"container",void 0),e$1([d$1()],p$1.prototype,"content",void 0),e$1([d$1()],p$1.prototype,"open",void 0),e$1([d$1(),e$2("esri/t9n/common")],p$1.prototype,"messages",void 0),e$1([d$1({aliasOf:"messages.auth.signIn"})],p$1.prototype,"title",void 0),p$1=e$1([n$1("esri.identity.IdentityModal")],p$1);const u=p$1;
