import { y, aK as C, r, t, aM as O, aw as A, e, d, n } from './cast-3d5be210.js';
import { a } from './HandleOwner-fe336959.js';
import { v } from './Polyline-dcdb3782.js';
import { f as fn, A as An, r as rn } from './projection-fbd5d346.js';
import { f } from './normalizeUtilsSync-1f2b7f6d.js';
import { b as i } from './geometry-2f332a26.js';
import { t as te } from './featureConversionUtils-3f60eb15.js';
import { s } from './OptimizedFeature-a0dba562.js';
import { u } from './FeatureStore-3cedab83.js';
import { Y } from './QueryEngine-115f26ee.js';
import { a as r$1 } from './DimensioningAnalysisView3D-c2c2dfcd.js';
import { o } from './queryEngineUtils-4f36f40a.js';
...
*/
let w=class extends(a(y)){constructor(e){super(e),this.availability=1,this.sources={multipoint:null,point:null,polygon:null,polyline:null},this.loadedWkids=new Set,this.loadedWkts=new Set,this.pendingAdds=[];}get updating(){return this.updatingHandles.updating}get layer(){return this.layerSource.layer}destroy(){const e=this.pendingAdds;this.pendingAdds.length=0;for(const t of e)t.task.abort();this._mapSources((e=>this._destroySource(e)));}initialize(){this.handles.add([this.layer.on("graphic-update",(e=>this._onGraphicUpdate(e))),this.updatingHandles.addOnCollectionChange((()=>this.layer.graphics),(e=>this._onGraphicsChanged(e)))]),this._addMany(this.layer.graphics.toArray());}async fetchCandidates(e,t){const r$2=await C(this._mapSources((r$1=>r$1.queryEngine.executeQueryForSnapping({point:e.coordinateHelper.vectorToPoint(e.point).toJSON(),distance:e.distance,types:e.types,query:r(e.filter)?e.filter.createQuery().toJSON():{where:"1=1"}},t).then((({candidates:e})=>e))))),s=r$2.flat().map((t=>o(t,e.coordinateHelper,e.elevationInfo)));return r$1(e.point,s),s}refresh(){}_onGraphicUpdate(e){switch(e.property){case"geometry":case"visible":this._remove(e.graphic),this._addMany([e.graphic]);}}_onGraphicsChanged(e){for(const t of e.removed)this._remove(t);this._addMany(e.added);}_addMany(e){const t$1=[],r=new Map;for(const s of e)t(s.geometry)||(this._needsInitializeProjection(s.geometry.spatialReference)?(t$1.push(s.geometry.spatialReference),r.set(s.uid,s)):this._add(s));this._createPendingAdd(t$1,r);}_createPendingAdd(e,t){if(!e.length)return;const s=O((async r=>{await fn(e.map((e=>({source:e,dest:this.spatialReference}))),{signal:r}),this._markLoadedSpatialReferences(e);for(const[,e]of t)this._add(e);}));this.updatingHandles.addPromise(s.promise);const o={task:s,graphics:t},i=()=>A(this.pendingAdds,o);s.promise.then(i,i),this.pendingAdds.push(o);}_markLoadedSpatialReferences(e){for(const t of e)null!=t.wkid&&this.loadedWkids.add(t.wkid),null!=t.wkt&&this.loadedWkts.add(t.wkt);}_add(e){if(t(e.geometry)||!e.visible)return;let t$1=e.geometry;if("mesh"===t$1.type)return;"extent"===t$1.type&&(t$1=v.fromExtent(t$1));const r$1=this._ensureSource(t$1.type);if(t(r$1))return;const s=this._createOptimizedFeature(e.uid,t$1);r(s)&&r$1.featureStore.add(s);}_needsInitializeProjection(e){return (null==e.wkid||!this.loadedWkids.has(e.wkid))&&((null==e.wkt||!this.loadedWkts.has(e.wkt))&&!An(e,this.spatialReference))}_createOptimizedFeature(e,t){const r=rn(f(t),this.spatialReference);return r?new s(te(r,!1,!1),{[k]:e},null,e):null}_ensureSource(e){const t=this.sources[e];if(r(t))return t;const r$1=this._createSource(e);return this.sources[e]=r$1,r$1}_createSource(e){const t=i.toJSON(e),r$1=new u({geometryType:t,hasZ:!1,hasM:!1});return {featureStore:r$1,queryEngine:new Y({featureStore:r$1,fields:[{name:k,type:"esriFieldTypeOID",alias:k}],geometryType:t,hasM:!1,hasZ:!1,objectIdField:k,spatialReference:this.spatialReference,scheduler:r(this.view)&&"3d"===this.view.type?this.view.resourceController.scheduler:null}),type:e}}_remove(e){this._mapSources((t=>this._removeFromSource(t,e)));for(const t of this.pendingAdds)t.graphics.delete(e.uid),0===t.graphics.size&&t.task.abort();}_removeFromSource(e,t){const r=t.uid;e.featureStore.has(r)&&e.featureStore.removeById(t.uid);}_destroySource(e){e.queryEngine.destroy(),this.sources[e.type]=null;}_mapSources(e){const{point:t,polygon:r$1,polyline:s,multipoint:i}=this.sources,a=[];return r(t)&&a.push(e(t)),r(r$1)&&a.push(e(r$1)),r(s)&&a.push(e(s)),r(i)&&a.push(e(i)),a}};e([d({constructOnly:!0})],w.prototype,"spatialReference",void 0),e([d({constructOnly:!0})],w.prototype,"layerSource",void 0),e([d({constructOnly:!0})],w.prototype,"view",void 0),e([d({readOnly:!0})],w.prototype,"updating",null),e([d({readOnly:!0})],w.prototype,"availability",void 0),w=e([n("esri.views.interactive.snapping.featureSources.GraphicsSnappingSource")],w);const k="OBJECTID";
