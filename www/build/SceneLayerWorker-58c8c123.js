import { a_ as t, r } from './cast-3d5be210.js';
import { a as a$1 } from './assets-99f5c3ee.js';
import { o } from './I3SNode-418da2f2.js';
...
See https://js.arcgis.com/4.24/esri/copyright.txt for details.
*/
function e(){return n||(n=new Promise((t=>import('./i3s-19c83059.js').then((t=>t.i)).then((({default:e})=>{const n=e({locateFile:i$1,onRuntimeInitialized:()=>t(n)});delete n.then;})))).catch((t=>{throw t}))),n}function i$1(e){return a$1(`esri/libs/i3s/${e}`)}let n;
...
const SceneLayerWorker = /*#__PURE__*/Object.freeze({
	__proto__: null,
	destroyContext: l,
